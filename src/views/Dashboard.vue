...
const data = ref([
    {
        name: "Orders",
        number: 152,
        svg:'pi pi-shopping-cart text-blue-500 text-xl',
    },
    {
        name: "Orders",
        number: 152,
...
<template>
    <div class="grid">
        <div v-for="item in data" class="col-12 lg:col-6 xl:col-3">
            <div  class="card mb-0">
        ...
        <div class="col-12 xl:col-6">
            ...
            <Dropdown v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Select a City" class="w-full md:w-14rem" />
                ...
                <div class="bottom">
                    <table class="w-10">
                        <tbody>
                            <td class="grid align-items-center justify-content-between w-100 ">
                                <tr>
                                    <h6>Home screen iteration</h6>
                                   <Tag severity="danger" value="Heigh"></Tag>
                                </tr>
                                <tr class="flex gap-2">
                                    <i class="pi pi-book" style="cursor: pointer;">5</i>
                                    <i class="pi pi-book">10</i>
                                </tr>
                            </td>
                        </tbody>
                    </table>
