<template>
    ...
    <ScrollPanel style="width: 100%; height: 300px" class="flex justify-between gap-2 relative">
        <div v-for="(item, itemId) in comments" :key="itemId" class="left w-full mb-2 bg-slate-200 p-3" style="border-top-right-radius: 15px; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
