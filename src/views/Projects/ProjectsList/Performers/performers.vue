    ...
    <section class="flex flex-col gap-2">
        <div :class="card_table ? `top max-[900px]:w-full` : `w-full`">
            <div :class="card_table ? 'flex flex-col gap-4 p-3 rounded-2xl' : 'hidden'">
                ...
                <div class="bottom flex items-center justify-between gap-3 flex-wrap">
                    <div v-for="item in comunitiCard"
                        ...
                        <span class="flex items-center justify-center flex-col gap-2  p-3 w-full">
                            <img @click="gotoPerformersInfo(item.id)" src="https://avatars.mds.yandex.net/i?id=738b728f5728fc4d9b1bb45e0c787450ab62c59b-10705627-images-thumbs&n=13"
                                class="w-24 card-img  h-24 rounded-[50%] cursor-pointer" alt="">
                            <h1 class="font-bold">{{ item.user.fio}}</h1>
                            <h2 class="font-sans font-medium">{{ item.status }}</h2>
                            <h4>{{ item.rols }}</h4>
                        ...
                        <li
                            ...
                            <div class="w-[35%] flex items-center gap-2">
                                ...
                                <span class="flex w-1/4 items-center justify-center gap-2">
                                    <Avatar @click="router.push(`/performersinfo`)" class="cursor-pointer" image="https://avatars.mds.yandex.net/i?id=738b728f5728fc4d9b1bb45e0c787450ab62c59b-10705627-images-thumbs&n=13" size="large" shape="circle">
                                    </Avatar>
                                </span>
